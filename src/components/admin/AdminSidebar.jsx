...
const AdminSidebar = () => {
    ...
    const Menu = [
        ...
        { title: "Categorys", icon: <MdCategory className="text-black" />, path: "/admin/categories" },
        { title: "Subcategorys", icon: <MdOutlineCategory className="text-black" />, path: "/admin/subcategories" },
